...
// Variable for the rectangle sweep function
float sweepX;
...
void draw() {
  ...
  // This function just draws a rectangle that sweeps over the dome
  // You can "comment it out" by putting two forward slashes at the start of the line,
  // and then write your own code here instead. 
  sweep();
  
  // Write any code you want to appear on the dome here!
