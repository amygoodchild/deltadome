...
// Scales down the LED mapping for a lower resolution monitor than the one I mapped them on
float scale = 0.7;
...
// Clusters are the background animation
Cluster[] clusters;
int numberOfClusters = 70;
int numberOfClusterstoDisplay = 70; // When there's lot of action happening inside the dome, this number goes down
int action; // Counts up how much action is going on
